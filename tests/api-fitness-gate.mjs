...
// settings.addons + db.healthEntries + db.athleteProfile live in cases.json) — but ONLY when
...
//   COS_BOARD_DATA=<that board's cases.json> node tests/api-fitness-gate.mjs   # CRM_BASE_URL defaults to :3000
//
