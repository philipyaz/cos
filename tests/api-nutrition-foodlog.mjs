...
//
// It snapshots board/data/cases.json first and restores it in a `finally` (net-zero — db.foodLogs
...
//   COS_BOARD_DATA=<that board's cases.json> node tests/api-nutrition-foodlog.mjs   # CRM_BASE_URL defaults to http://localhost:3000
//
