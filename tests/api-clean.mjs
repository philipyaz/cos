...
//
// Snapshots board/data/cases.json first and restores it in a `finally` (net-zero — cases,
// messages AND reminders all live in cases.json) — but ONLY when COS_BOARD_DATA is set: unset
...
//   COS_BOARD_DATA=<that board's cases.json> node tests/api-clean.mjs         # CRM_BASE_URL defaults to http://localhost:3000
//
