...
//
// It snapshots board/data/cases.json first and restores it in a `finally` (net-zero — db.priorities
// lives in cases.json alongside the cases, and CaseRecord.starred too) — but ONLY when
...
//   COS_BOARD_DATA=<that board's cases.json> node tests/api-priorities.mjs    # CRM_BASE_URL defaults to http://localhost:3000
//
