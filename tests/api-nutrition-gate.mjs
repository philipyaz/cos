...
// settings.addons + db.foodLogs live in cases.json) — but ONLY when COS_BOARD_DATA is set: unset
...
//   COS_BOARD_DATA=<that board's cases.json> node tests/api-nutrition-gate.mjs    # CRM_BASE_URL defaults to http://localhost:3000
//
