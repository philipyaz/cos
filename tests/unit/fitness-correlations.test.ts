// Unit tests for the pure athlete statistics (board/lib/fitness-correlations.ts) — the
...
import { pearson, linearRegression } from "../../board/lib/fitness-correlations.ts";
