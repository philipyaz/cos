...
const GET_NEEDS_ATTENTION_TOOL = {
  ...
  description:
    ...
    "RISES with days idle (×1), days overdue (×2), and a passed-unactioned chase block (×3); an " +
    ...
    "priority — raw intake), unlinked (no vaultLinks, not done). Buckets OVERLAP (a case can be " +
