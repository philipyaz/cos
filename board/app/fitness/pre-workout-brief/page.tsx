...
// Keyed on the English readiness vocabulary the /api/fitness/pre-workout-brief route
...
export default function PreWorkoutBriefPage() {
  ...
  const generate = async () => {
    ...
    setBrief(null);
    try {
      const res = await fetch("/api/fitness/pre-workout-brief");
  ...
  return (
    <>
      <TopBar crumbs={["Cos", "Fitness", "Pre-workout brief"]} />
