...
// POST /api/athlete/push-plan-to-calendar — materialize a generated training plan as calendar
// events (db.events). GATED on the "health" add-on (assertAddonEnabled is the FIRST statement in
