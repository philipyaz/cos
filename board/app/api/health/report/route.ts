...
// GET /api/health/report?days=N — compose a human-readable Markdown health report
// (for vault ingestion) from the canonical summarize() OUTPUT SHAPE. This is the
// MCP-facing surface: the health MCP's ingest_health_to_vault tool fetches this and
