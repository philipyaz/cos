...
| **[`/nutrition-chef`](./nutrition-chef/SKILL.md)** | Plans the week's meals from what's on hand (preferring what's expiring), honoring allergies + diet, onto the calendar by default — after the standing meal-plan reconcile. | `Run /nutrition-chef plan this week's meals, preferring what's expiring` | Sunday |
