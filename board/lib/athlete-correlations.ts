// Pure statistics for the athlete /correlations surface — Pearson correlation + ordinary
// least-squares linear regression over paired numeric series. No I/O, no store access, no
// HTTP: the route (board/app/api/athlete/correlations) reads the canonical health entries via
