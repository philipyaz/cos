// Pure "form score" (daily readiness) computation for the fitness surface. It reads the
// CANONICAL health-entry taxonomy (board/lib/types.ts) via listEntries from @/lib/fitness —
